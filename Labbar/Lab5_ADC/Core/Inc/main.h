...
#define ADC_VRX_Pin GPIO_PIN_0
#define ADC_VRX_GPIO_Port GPIOC
#define ADC_VRY_Pin GPIO_PIN_1
#define ADC_VRY_GPIO_Port GPIOC
#define ADC_SEN_Pin GPIO_PIN_2
#define ADC_SEN_GPIO_Port GPIOC
